...
public class FriendList extends Composite {
	...
	private final FriendsServiceAsync friendsService = GWT.create(FriendsService.class);
	...
	public void getFriendsSummaryList() {
		friendsService.getFriendSummaries(new AsyncCallback<ArrayList<FriendSummaryDTO>>() {
			@Override
	...
	private String truncateLongName(String displayName) {
		...
		String shorten = displayName.substring(0, MAX - SUFFIX.length()) + SUFFIX;
