...
public class MessageListView extends Composite {
  ...
  public MessageListView(List<MessageDTO> messageDTOs) {
    this();
  ...
  private void displayMessages() {
    for (MessageDTO messageDTO: messageDTOs) {
      messagesPanel.add(new MessageItem(messageDTO.getTitle(), messageDTO.getDescription(), messageDTO.getCreatedOn()));
    }
  }
