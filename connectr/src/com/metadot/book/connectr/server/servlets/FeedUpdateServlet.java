...
/**
 * Update the most recently-requested feeds, using the given request parameters. 
 * Processes up to 'max' update batches, where the size of the batch is 'num'.
 * Sorts feeds by dateRequested (descending), working on the more recently-requested first.
 */
...
public class FeedUpdateServlet extends HttpServlet {
  ...
  throws IOException {
    ...
    // bc is the batch count-- it is not set by the original request, but is a parameter
    // for the rest of the subtasks spawned.
