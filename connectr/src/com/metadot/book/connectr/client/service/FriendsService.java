...
@RemoteServiceRelativePath("friendsService")
public interface FriendsService extends RemoteService {

  ArrayList<FriendSummaryDTO> getFriendSummaries();

  String deleteFriend(String id) throws NotLoggedInException;

  FriendDTO getFriend(String id);

  FriendDTO updateFriend(FriendDTO friend);
}
